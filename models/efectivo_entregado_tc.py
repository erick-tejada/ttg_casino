...
class EfectivoEntregadoTC(models.Model):
    _name = 'casino.efectivotc.maquina'
    _description = "Efectivo Entregado TC Maquinas"
    ...
    def unlink(self):
        ...
        res = super(EfectivoEntregadoTC, self).unlink()
        return res